...
**Attention**: This package is a fork of [Larabook-Gateway](https://github.com/larabook/gateway), There was some esenssial changes that owners of the original package
did not accept in my pull requests, so i implemented that changes on this repo.
